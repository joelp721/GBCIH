...
// Function to display array entries
function displayArrayEntries() {
    // Get query parameters from URL
    const urlParams = new URLSearchParams(window.location.search);
    // Get the 'values' parameter which contains the array entries
    const valuesParam = urlParams.get('values');
    
    // Check if the 'values' parameter exists
    if (valuesParam) {
        // Parse the JSON string to retrieve the array
        const valuesArray = JSON.parse(decodeURIComponent(valuesParam));
        ...
        console.error("No array entries found in query parameters.");
    }
}
